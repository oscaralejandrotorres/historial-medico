...
class Frame(tk.Frame):
    ...
    def guardarPaciente(self):
        persona = Persona(
            self.svNombre.get(), self.svApellido.get(), self.svDni.get(), self.svFecNacimiento.get(), self.svEdad.get(), self.svAntecentes.get(),
        ...
        self.topCalendario = tk.Toplevel()  # o cualquier otro widget que deseas destruir
    ...
    def tablaPaciente(self, where=""):
        ...
        self.tabla = ttk.Treeview(self, column=('Nombre', 'Apellido','Dni','FNacimiento','Edad','Antecedentes','Correo','Telefono'))
        ...
        self.tabla.column("#7", anchor=W, width=250)
        self.tabla.column("#8", anchor=W, width=82)
    ...
    def historiaMedica(self):
        ...
        try:
            ...
            self.tablaHistoria.heading('#1', text='Nombres y Apellido')
