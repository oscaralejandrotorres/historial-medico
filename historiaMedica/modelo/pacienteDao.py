...
def editarDatoPaciente(persona, idPersona):
    conexion = ConexionDB()
    sql = f"""UPDATE Persona SET nombre = '{persona.nombre}', apellido = '{persona.apellido}', dni = '{persona.dni}', fechaNacimiento = '{persona.fechaNacimiento}',
...
def guardarDatoPaciente(persona):
    conexion = ConexionDB()
    sql = f"""INSERT INTO Persona (nombre, apellido,
...
class Persona:
    def __init__(self, nombre, apellido, dni,fechaNacimiento, edad, antecedentes,correo, telefono):
        self.idPersona = None
        self.nombre = nombre
    ...
    def __str__(self):
        return f'Persona[{self.nombre},{self.apellido}, {self.dni},{self.fechaNacimiento},{self.edad},{self.antecedentes},{self.correo},{self.telefono}]'